    ...
    <main style="background: rgb(225, 225, 225);">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Visor violado</h1>
            </div>
            <div class="container__teste__texto-video">
                    <h1 class="titulo__texto"><b>Como identificar um visor violado?</b></h1>
                    <img class="img__treinamento" src="./img/Visor_violado.jpg" alt="">
                    <img class="img__treinamento" src="./img/Visor_violado2.jpg" alt="">
                    <h2 class="descricao__texto">
                        A identificação de um visor violado será feita visualmente, caso apresente 
                        qualquer tipo de avaria, a garantia não irá cobrir quaisquer defeitos, mesmo que procedentes.
                    </h2>
            </div>
        </section>
    </main>
