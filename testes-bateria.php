                    ...
                    <ul class="ul__pastas">
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./desligamento.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icon-desligamento.png" alt="">
                        ...
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./bateria-descarregada.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icon-descarregada.png" alt="">
                        ...
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./bateria-normal.php">
                            <div class="container__imagem-pasta--texto">
                                <img class="icone__pasta" src="./img/icon-bateria_normal.png" alt="">
                        ...
                        <li class="itens-lista__pastas"><a class="link-itens-lista__pastas" href="./sobrecarga.php">
                            <div class="container__imagem-pasta--texto">
                                <img style="width: 70px;" class="icone__pasta" src="./img/icon-sobrecarga.png" alt="">
