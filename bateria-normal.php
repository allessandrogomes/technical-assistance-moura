    ...
    <main>
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Bateria normal</h1>
            </div>
            <div class="container__teste__texto-video">
                <h2 class="teste__texto">Nesse vídeo será mostrado como identificar uma bateria normal Moura/Zetta para carros, para isso será preciso um equipamento adequado. O TB-300 foi utilizado nesse vídeo para efetuar o teste em uma bateria de 60Ah. A utilização de um multímetro digital auxiliar é opcional. Antes de iniciar, preste atenção aos requisitos:
                    <b> OBS¹: Bateria EFB / AGM Deverá estar com tensão acima de 12,65V </b>
                </h2>
                <iframe class="treinamento__video" src="https://www.youtube.com/embed/7DjPO3CepoM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </section>
    </main>
    <footer class="rodape">
