    ...
    <main style="background: rgb(225, 225, 225);">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Caixa danificada</h1>
            </div>
            <div class="container__teste__texto-video">
                    <h1 class="titulo__texto"><b>Como identificar uma caixa danificada?</b></h1>
                    <img class="img__treinamento" src="./img/Caixa_danificada.jpg" alt="">
                    <h2 class="descricao__texto">
                        A identificação de uma caixa danificada será feita visualmente, caso apresente 
