    ...
    <main style="background: rgb(225, 225, 225);">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Polo danificado</h1>
            </div>
            <div class="container__teste__texto-video">
                    <h1 class="titulo__texto"><b>Como identificar um polo danificado?</b></h1>
                    <img class="img__treinamento" src="./img/Polo_danificado.jpg" alt="">
                    <h2 class="descricao__texto">
                        A identificação do polo danificado será feita visualmente, caso apresente 
