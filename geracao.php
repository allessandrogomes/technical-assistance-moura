    ...
    <main>
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Geração</h1>
            </div>
            <div class="container__teste__texto-video">
                <h2 class="teste__texto">Nesse vídeo será mostrado como fazer o teste de geração em um veículo (o teste também serve para motos).
                    <b> OBS¹: Bateria EFB / AGM Deverá estar com tensão acima de 12,65V para ser considerada carregada </b>
                </h2>               
                <iframe class="treinamento__video" src="https://www.youtube.com/embed/vPtyks7X2Iw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </section>
    </main>
    <footer class="rodape">
