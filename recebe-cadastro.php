...
<?php
    ...
    $consulta = mysqli_query($conexao, "SELECT usuario FROM usuario WHERE usuario = '$cnpj'");
    

    if(mysqli_num_rows($consulta) >= 1) {
        exit;
    } else {
        $result = mysqli_query($conexao, "INSERT INTO usuario(usuario, senha, razao_social, email, telefone, perfil) VALUES ('$cnpj','$senha','$razao_social','$email','$telefone','1')");
    }
?>