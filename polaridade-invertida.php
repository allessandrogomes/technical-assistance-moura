    ...
    <main style="background: rgb(225, 225, 225);">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Polaridade invertida</h1>
            </div>
            <div class="container__teste__texto-video">
                    <h1 class="titulo__texto"><b>Como identificar uma polaridade invertida?</b></h1>
                    <img class="img__treinamento" src="./img/Polaridade_invertida.jpg" alt="">
                    <img class="img__treinamento" src="./img/Polaridade_invertida_2.jpg" alt="">
                    <h2 class="descricao__texto">
                        A identificação de uma polaridade invertida será feita através de um teste, 
                        onde é possível observar a inversão com o sinal negativo no multímetro (Imagem 1) ou ponteiro 
                        analógico em direção anti horária (Imagem 2). Isso geralmente ocorre quando se carrega a bateria
                        com os cabos invertidos, então é preciso tomar cuidado ao se carregar uma bateria em carregador comum.
                        A garantia não irá cobrir quaisquer defeitos, mesmo que procedentes.
                    </h2>
            </div>
        </section>
    </main>
