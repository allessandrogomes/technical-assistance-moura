    ...
    <main style="background: white;">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Roteiro de inspeção de garantia e testes</h1>
            </div>
            <div class="container__teste__texto-video">
                <a class="pdf_download" download href="./pdf/Roteiro de inspeção de garantia e testes.pdf">Baixar PDF</a>
                <embed class="treinamentos__pdf" src="./pdf/Roteiro de inspeção de garantia e testes.pdf#view=FitH" width="100%" type="application/pdf";>
            </div>
        </section>
    </main>
    <footer class="rodape">
