    ...
    <main style="background: white;">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Guia de verificação e instalação de baterias</h1>
            </div>
            <div class="container__teste__texto-video">
                <a class="pdf_download" download href="./pdf/Guia de verificação e instalação de baterias.pdf">Baixar PDF</a>
                <embed class="treinamentos__pdf" src="./pdf/Guia de verificação e instalação de baterias.pdf#view=FitH" width="100%" type="application/pdf";>
            </div>
        </section>
    </main>
    <footer class="rodape">
