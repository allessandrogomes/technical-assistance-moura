    ...
    <main style="background: rgb(225, 225, 225);">
        <section class="container-principal__teste">
            <div class="titulo-principal__texto--icone">
                ...
                <h1 class="titulo-principal__pastas">Aplicação incorreta</h1>
            </div>
            <div class="container__teste__texto-video">
                    <h1 class="titulo__texto"><b>Porque se deve instalar a bateria recomendada?</b></h1>
                    <img class="img__treinamento" src="./img/instalar-bateria.png" alt="">
                    <h2 class="descricao__texto">
                        Ao instalar uma bateria Moura/Zetta, é importante ter certeza de que está instalando 
                        a bateria correta, pois caso contrário poderá ocasionar futuros problemas, tanto para 
                        a vida útil da bateria, quanto do veículo. Para evitar tais problemas e instalar sempre 
                        corretamente, acesse o <a style="color: blue;" target="_blank" href="https://www.moura.com.br/descubra-qual-a-sua-bateria/"><b>"Sua bateria"</b></a> e verifique os modelos recomendados para o devido veículo.
                    </h2>
            </div>
        </section>
    </main>
